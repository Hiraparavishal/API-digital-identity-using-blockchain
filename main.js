...
app.all("/Gender/:fname/:mname/:lname/:Gender", function(req, res) {
  console.log("in url");
  var flag=0;
  if (!firebase.apps.length) {
    firebase.initializeApp(firebaseConfig);
...
app.all("/BirthDate/:fname/:mname/:lname/:BirthDate", function(req, res) {
  console.log("in url");
  var flag=0;
  if (!firebase.apps.length) {
    firebase.initializeApp(firebaseConfig);
  ...
  console.log("after data");
   ref
    .orderByChild("BirthDate")
    .equalTo(req.params.BirthDate)
    .on(
      "child_added",
      function(snapshot) {
         flag=1;
...
app.all("/PinCode/:fname/:mname/:lname/:PinCode", function(req, res) {
  console.log("in url");
  var flag=0;
  if (!firebase.apps.length) {
    firebase.initializeApp(firebaseConfig);
...
app.all("/Incomeproof/:fname/:mname/:lname/:incomecertino", function(req, res) {
  console.log("in land record");
  var flag=0;
  if (!firebase.apps.length) {
    firebase.initializeApp(firebaseConfig);
  }
  ...
  var ref = database.ref("Income");
   ref
    .orderByChild("incomecertino")
    .equalTo(req.params.incomecertino)
    .on(
      "child_added",
      function(snapshot) {
         flag=1;
...
app.all("/Property/:fname/:mname/:lname/:propertyno", function(req, res) {
  console.log("in land record");
  var flag=0;
  if (!firebase.apps.length) {
    firebase.initializeApp(firebaseConfig);
  ...
  var database = firebase.database();
  var ref = database.ref("Property");
   ref
    .orderByChild("propertyno")
    .equalTo(req.params.propertyno)
    .on(
      "child_added",
      function(snapshot) {
         flag=1;
...
app.all("/LanRecord/:fname/:mname/:lname/:landno", function(req, res) {
  console.log("in land record");
  var flag=0;
  if (!firebase.apps.length) {
    firebase.initializeApp(firebaseConfig);
  ...
  var database = firebase.database();
  var ref = database.ref("LandRecord");
   ref
    .orderByChild("landno")
    .equalTo(req.params.landno)
    .on(
      "child_added",
      function(snapshot) {
         flag=1;
...
app.listen(3030, () => console.log("server start at port 3030"));
